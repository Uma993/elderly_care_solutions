    ...
    <div className="dashboard-expanded">
      ...
      <div className="dashboard-hero-grid">
        ...
        <button
          ...
          style={heroCardStyle('#a855f7')}
          aria-label="Profile"
          className={hoverSegment === 'profile' ? 'dashboard-hero-card--hover' : ''}
          ...
          tabIndex={0}
        >
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>
          Profile
        </button>
        <button
          type="button"
